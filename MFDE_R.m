function data_MFDE = MFDE_R(Tasks,pop,gen,selection_process,rmp,p_il,reps,index)
...
%         end
        ...
        for i = 1 : pop
            ...
            if urmp<=rmp
                ...
                switch nn
                    case 2
                        newpos = Fr*((p2pos * QQ{sourceskill2}' - p3pos * QQ{sourceskill3}'));
                    case 3
                        newpos = Fr*((p2pos * QQ{sourceskill2}' - p3pos * QQ{sourceskill3}')) + 0.5*Fr*(Pm(sourceskill2,:)- Pm(sourceskill3,:));
                    case 1
